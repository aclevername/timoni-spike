...
```shell
timoni -n default apply redis-promise oci://<container-registry-url>
```
...
```shell
timoni -n default apply redis-promise oci://ghcr.io/<container-registry-url> \
...
```shell
timoni -n default delete redis-promise
```
